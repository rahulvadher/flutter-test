...
class TradingActivationPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => TradingActivationPageState();
}

class TradingActivationPageState extends State<TradingActivationPage> {
  int group1 = 1;
  int group2 = 1;
