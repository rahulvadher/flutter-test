...
class StockDematHoldingPage extends StatefulWidget {
  const StockDematHoldingPage({Key? key}) : super(key: key);
  State<StatefulWidget> createState() => StockDematHoldingPageState();
}

class StockDematHoldingPageState extends State<StockDematHoldingPage> {
  ...
  getDematHolding() async {
    singleClient = globals.clientList[globals.codeIndex];
    Map<String, String> headerParam = {
      'Authorization': globals.accessToken,
    };
   await  ApiService.getMethod(
      '${Constants.middleWareBaseUrl}/api/v1/holding/demat/${singleClient.clientCode}', context,
