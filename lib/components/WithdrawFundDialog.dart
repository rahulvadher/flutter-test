...
class WithdrawFundDialog extends StatefulWidget {
  State<StatefulWidget> createState() => WithdrawFundDialogState();
}

class WithdrawFundDialogState extends State<WithdrawFundDialog> {
